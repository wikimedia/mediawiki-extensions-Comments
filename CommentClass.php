...
class Comment extends ContextSource {
	...
	/**
	 * Sort the comments, by thread and timestamp, and by $wgCommentsDescendingSort
	 *
	 * @param $x
	 * @param $y
	 * @return int
	...
	public static function sortCommentList( $x, $y ) {
		global $wgCommentsDescendingSort;
	 ...
	 *
	 * @param $voteType: up (+1) vote or down (-1) vote
	 * @return string
	 */
	 ...
	 *
	 * @param $blockList: list of users the current user has blocked
	 * @param $anonList: map of ip addresses to names like anon#1, anon#2
	 * @return string: html
	 */
