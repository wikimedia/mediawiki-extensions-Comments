...
<nav class="mw-ui tabs card">
	...
	?>
	<ul class="tabs-items">
		<li><a class="tab-item write tab-item-open" data-linked-element="item-1"><?php echo wfMessage( 'comments-tab-write' )->plain() ?></a></li>
		<li><a class="tab-item preview" data-linked-element="item-2"><?php echo wfMessage( 'comments-tab-preview' )->plain() ?></a></li>
	</ul>
	<ul class="tabs-content">
		...
		<li class="tab-content write tab-content-open" id="item-1">
			...
			<form action="" method="post" name="commentForm">
				<textarea name="commentText" id="comment" class="mw-ui textarea" placeholder="<?php echo wfMessage( 'comments-textarea-placeholder' )->plain() ?>" rows="8" maxlength="1500"></textarea>
